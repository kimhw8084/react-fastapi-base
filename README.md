...
`1.0.0-rc.16` — company storage persistence contract and profile-owned maintenance qualification candidate; V1 local code complete; company qualification pending.
