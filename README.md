...
`1.0.0-rc.17` — independent frontend/backend deployment contract and source-bound repository qualification candidate; V1 local code complete; company qualification pending.
