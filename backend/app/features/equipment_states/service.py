...
CRUD=RevisionCrudService(model=EquipmentState,create_schema=EquipmentStateCreate,read_schema=EquipmentStateRead,workspace=WORKSPACE,not_found_label='Equipment State',normalize_values=normalize_equipment_state)
