...
class PlanTaskCreate(StrictSchema):
    ...
    resource_group: str | None=Field(default=None,max_length=120)
    effort_hours: float=Field(default=8.0,gt=0,le=100000)
    capacity_hours: float=Field(default=8.0,gt=0,le=100000)
