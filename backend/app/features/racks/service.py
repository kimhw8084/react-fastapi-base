...
WORKSPACE='racks'
SORTS={'name':Rack.name,'site':Rack.site,'row_name':Rack.row_name,'rack_units':Rack.rack_units,'power_capacity_kw':Rack.power_capacity_kw,'status':Rack.status,'updated_at':Rack.updated_at,'created_at':Rack.created_at,'created_by':Rack.created_by,'revision':Rack.revision}
