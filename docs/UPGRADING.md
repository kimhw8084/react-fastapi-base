...
The review build implements a hash-bound, conflict-refusing upgrade apply and rollback for the managed platform core. It does not migrate application-owned schema or silently reconcile local divergence.
