> **Implementation addendum (1.0.0-rc.17):** this candidate adds the source-bound independent frontend/backend deployment contract and two-process repository qualification on top of RC.16's explicit company storage seam. Earlier release artifacts remain immutable historical evidence for their exact sources. The API major/revision compatibility policy and staged frontend/backend bootstrap negotiation remain unchanged. Company qualification remains external and this design is not production evidence.
...
**Version: 1.0.0-rc.17 · Reference: SysGrid 66244b997a70b85e6e887870c96db958f3f0d22d · Release: NOT_CERTIFIED**
