...
function TenantApplication({boot,runtime}:{boot:Bootstrap;runtime:RuntimeConfig}){
 ...
 const [modePreference,setModePreference]=useState<ColorModePreference>(()=>readStorage(appearancePreference,'system',isColorModePreference))
